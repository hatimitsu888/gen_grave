...
# 追加
$data modify storage gg_common:dialog graves.actions append value {"label":{"text":"$(name)    [$(dimension)]"}, "width":270, "action":{"type":"minecraft:run_command", "command":"trigger gg.playerSetting set $(triggerA)"}}
